...
const QRMO_I18N = (() => {
  ...
  const DICT = {
    ar: {
      ...
      'scan.torch.on': 'تشغيل الفلاش', 'scan.torch.off': 'إيقاف الفلاش',
      'scan.hint.scanning': 'وجّه الكود داخل المربع وثبّت الموبايل لحظة.',
      'scan.hint.move': 'قرّب أو بعّد الموبايل قليلًا حتى يظهر الكود بوضوح داخل المربع.',
      'scan.hint.found': 'تمت قراءة الكود ✓',
      'scan.divider': 'أو',
      ...
      'scan.err.decoder': 'الكاميرا شغالة لكن مكتبة قراءة QR لم تُحمّل. تأكد من الاتصال ثم أعد تحميل الصفحة.',
    ...
    en: {
      ...
      'scan.torch.on': 'Turn on flash', 'scan.torch.off': 'Turn off flash',
      'scan.hint.scanning': 'Keep the QR code inside the square and hold the phone steady for a moment.',
      'scan.hint.move': 'Move the phone slightly closer or farther away until the code is sharp inside the square.',
      'scan.hint.found': 'QR code read ✓',
      'scan.divider': 'or',
      ...
      'scan.err.decoder': 'The camera is running, but the QR decoder did not load. Check the connection and reload the page.',
